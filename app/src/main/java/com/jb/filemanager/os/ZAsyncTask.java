...
/**
 * 为了在低版也能用到高版本的API, 复制官方源代码的{@code AsyncTask}.<br>
 * 官方源码版本: SDK 5.0.1<br>
 * @param <Params>
 * @param <Progress>
 * @param <Result>
...
public abstract class ZAsyncTask<Params, Progress, Result> {
    ...
    private static final String LOG_TAG = "ZAsyncTask";
    ...
    private static final ThreadFactory sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "ZAsyncTask #" + mCount.getAndIncrement());
        }
    };
    ...
    private static class SerialExecutor implements Executor {
        final ZArrayDeque<Runnable> mTasks = new ZArrayDeque<Runnable>();
        Runnable mActive;
     ...
     */
    public final ZAsyncTask<Params, Progress, Result> execute(Params... params) {
     ...
     * @see #execute(Object[])
     */
    public final ZAsyncTask<Params, Progress, Result> executeOnExecutor(
    ...
    private static class AsyncTaskResult<Data> {
        ...
        AsyncTaskResult(@SuppressWarnings("rawtypes") ZAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
