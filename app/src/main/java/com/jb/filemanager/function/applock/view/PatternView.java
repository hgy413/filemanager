...
import com.jb.filemanager.function.applock.util.PatternUtils;
...
//    private AudioManager mAudioManager;
        ...
        public boolean equals(Object o) {
            if (o != null) {
                ...
                if (o instanceof Cell) {
                    cell = (Cell) o;
                    if (this.column == cell.column && this.row == cell.row) {
                        return true;
                    }
                }
            }
    ...
    public PatternView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPathWidth = a.getDimensionPixelSize(R.styleable.PatternView_pl_dot_line_width, 9);
        mDotSize = a.getDimensionPixelSize(R.styleable.PatternView_pl_dot_size, 36);
        mDotSizeActivated = a.getDimensionPixelSize(R.styleable.PatternView_pl_dot_size_activated, 84);
        a.recycle();
...
//        mAudioManager = (AudioManager) getContext().getSystemService(Context.AUDIO_SERVICE);
    ...
    public void setRegularColor(@ColorInt int regularColor) {
