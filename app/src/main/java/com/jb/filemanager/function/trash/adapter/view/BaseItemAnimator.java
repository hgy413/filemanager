...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
  ...
  public boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder, int fromX, int fromY,
    ...
    if (newHolder != null && newHolder.itemView != null) {
      ...
      //注掉这3行   是为了不让更新的时候出现闪烁 ---add by lqf 2017年5月5日16:59:24
  ...
  protected class DefaultRemoveVpaListener extends VpaListenerAdapter {
    ...
    @Override public void onAnimationStart(View view) {
      ...
      Logger.d("DefaultRemoveVpaListener:onAnimationStart", "[view]:" + mTimeMillis);
    }
    ...
    @Override public void onAnimationEnd(View view) {
      Logger.d("DefaultRemoveVpaListener:onAnimationStart", "[view]:" + (System.currentTimeMillis() - mTimeMillis));
      ViewHelper.clear(view);
