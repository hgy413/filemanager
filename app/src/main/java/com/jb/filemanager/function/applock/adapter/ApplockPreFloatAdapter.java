...
/**
 * Created by nieyh on 17-7-11.
 */

public class ApplockPreFloatAdapter extends AbsAdapter<AppLockGroupData> {

    private int mWidthSpliterHeight;
    private int mNarrowSpliterHeight;
    private int mMarginLeft;

    public ApplockPreFloatAdapter(List<AppLockGroupData> groups) {
        super(groups);
    ...
    class ItemViewHolder {
        ...
        ItemViewHolder(View parent) {
            ...
            mAppLockItemGroupSelectBox.setImageSource(R.drawable.choose_none, R.drawable.choose_all, R.drawable.choose_all);
        }
    }
