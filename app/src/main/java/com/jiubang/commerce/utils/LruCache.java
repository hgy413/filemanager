...
public class LruCache<K, V> {
    ...
    public final V get(K r6) {
        ...
        L_0x005b:
            ...
            goto L_0x001c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.jiubang.commerce.utils.LruCache.get(java.lang.Object):java.lang.Object");
    }
        ...
        while (true) {
            synchronized (this) {
                if (this.size >= 0 && (!this.map.isEmpty() || this.size == 0)) {
                    if (this.size > maxSize2) {
                        try {
                            eldestEntry = (Map.Entry) ReflectUtil.invokeMethod(this.map, "eldest", new Object[0]);
                        } catch (Throwable e) {
                            e.printStackTrace();
                            Log.e("wbq", "Map eldest error", e);
                            eldestEntry = this.map.entrySet().iterator().next();
                        }
                        Map.Entry<K, V> toEvict = eldestEntry;
                        if (toEvict != null) {
                            key = toEvict.getKey();
